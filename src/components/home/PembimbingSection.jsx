        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 relative z-10">
            ...
            <div className="text-center sm:text-left flex-1">
              ...
              <p className="font-medium mb-4 text-sm sm:text-base" style={{ color: '#38bdf8' }}>Pembimbing Rayon Wikrama 2</p>
              <blockquote className="relative">
                <span className="text-4xl font-serif leading-none" style={{ color: '#38bdf8' }}>"</span>
                <p className="text-sm sm:text-base leading-relaxed italic -mt-2 px-3" style={{ color: '#CBD5E1' }}>
                  Mendidik bukan hanya mengajar, tetapi membentuk karakter untuk masa depan.
                </p>
                <span className="text-4xl font-serif leading-none float-right" style={{ color: '#38bdf8' }}>"</span>
