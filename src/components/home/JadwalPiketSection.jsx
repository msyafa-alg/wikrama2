        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-white leading-snug">
              ...
              <span style={{ color: '#38bdf8' }}>Tanggung Jawab Bersama</span>
            </h3>
              ...
              {tips.map((tip, i) => (
                ...
                >
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
                    ...
                    <tip.icon className="w-5 h-5" style={{ color: '#38bdf8' }} strokeWidth={1.8} />
                  </div>
                  <p className="text-sm leading-relaxed" style={{ color: '#CBD5E1' }}>{tip.text}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
