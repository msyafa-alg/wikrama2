...
const TentangSection = () => {
  ...
  return (
    <section ref={ref} id="tentang" className="py-20 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">Tentang Rayon</h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 leading-snug">
              Rayon Wikrama 2 –<br/>
              <span style={{ color: '#0F4C81' }}>Keluarga Besar yang Berprestasi</span>
            </h3>
              ...
              {features.map((f, i) => (
                ...
                >
                  <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0"
                    ...
                    <f.icon className="w-5 h-5 text-[#0F4C81]" strokeWidth={1.8} />
                  </div>
